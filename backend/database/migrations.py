...
-- ============================================================================
-- SIGNALS PERFORMANCE TRACKING (New Recommendation Services)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS signal_performance (
  ...
  roi_pct NUMERIC(8,4),
  is_winning BOOLEAN,
  outcome TEXT CHECK (outcome IN ('WINNING_TRADE', 'LOSING_TRADE')),
...
CREATE TABLE IF NOT EXISTS market_correlations (
  ...
  correlation_1d NUMERIC(5,3),
  correlation_7d NUMERIC(5,3),
  correlation_30d NUMERIC(5,3),
  volatility_1d NUMERIC(8,6),
  volatility_7d NUMERIC(8,6),
  volatility_30d NUMERIC(8,6),
  trend_strength_1d NUMERIC(5,3),
  trend_strength_7d NUMERIC(5,3),
  trend_strength_30d NUMERIC(5,3),
  divergence_detected BOOLEAN DEFAULT FALSE,
  divergence_strength NUMERIC(5,3),
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
