-- AlphaForge Phase 1 Supabase initialization
-- Source: backend/database/migrations.py (normalized for direct SQL Editor execution)
...
-- ============================================================================
-- STRATEGIES / SUBSCRIPTIONS / BACKTESTS
-- ============================================================================
...
DROP POLICY IF EXISTS "Users can see own portfolio" ON portfolios;
DROP POLICY IF EXISTS "Users can see own trades" ON paper_trades;
...
-- Quick verification (run after script):
